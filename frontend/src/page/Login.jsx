...
function Login() {
  ...
  return (
    <>
    <form onSubmit={handleSubmit} className=' flex items-center justify-center h-screen flex-col border-2'>
       <div className=' size-60 border-2 p-2'>
        ...
        <button type="submit" className=' border-2 p-2 mt-2 w-full rounded-sm '>Login</button>
        </div>
    </form>
    </>
  )
